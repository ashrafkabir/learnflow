            ...
            if (prev) {
              dispatch({
                ...
                message: {
                  ...
                  meta: {
                    generatedBy: evt.data?.agent_name || undefined,
                    sourcesCount: Array.isArray((evt.data as any)?.sources)
                      ? (evt.data as any).sources.length
                      : undefined,
                  },
                },
              });
            ...
            >
              ...
              >
                ...
                <div className="mt-1 flex items-center justify-between gap-2">
                  ...
                  {msg.role === 'assistant' && (msg as any)?.meta?.generatedBy ? (
                    <p
                      data-component="message-meta"
                      className="text-[10px] text-gray-500 dark:text-gray-400"
                    >
                      Generated by: {(msg as any).meta.generatedBy}
                      {typeof (msg as any)?.meta?.sourcesCount === 'number'
                        ? ` · Sources used: ${(msg as any).meta.sourcesCount}`
                        : ''}
                    </p>
                  ) : null}
                </div>
