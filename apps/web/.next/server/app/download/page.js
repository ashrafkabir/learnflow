    ...
    (e.modules = {
      ...
      8380: (e, n, t) => {
        ...
        let d = [
              ...
              children: [
                'download',
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(t.bind(t, 9920)),
                        '/home/aifactory/.openclaw/workspace/learnflow/apps/web/src/app/download/page.tsx',
                      ],
                    },
                  ],
                },
            ...
            {
              layout: [
                () => Promise.resolve().then(t.bind(t, 7718)),
          ...
          c = ['/home/aifactory/.openclaw/workspace/learnflow/apps/web/src/app/download/page.tsx'],
          p = '/download/page',
      ...
      9920: (e, n, t) => {
        ...
        function r() {
          ...
          return (0, o.jsxs)('div', {
            ...
            children: [
              o.jsx('h1', {
                style: { fontSize: 40, fontWeight: 800, marginBottom: 16 },
                children: 'Download LearnFlow',
              }),
              o.jsx('p', {
                style: { fontSize: 18, color: '#6b7280', marginBottom: 48 },
                children: 'Available on all major platforms.',
              }),
              o.jsx('div', {
                'data-component': 'platform-auto-detect',
                'data-platforms': JSON.stringify(e.map((e) => ({ id: e.id, ua: e.ua }))),
              }),
              o.jsx('div', {
                style: {
                  display: 'grid',
                ...
                children: e.map((e) =>
                  (0, o.jsxs)(
                    ...
                    {
                      'data-platform': e.id,
                      'aria-label': `Download for ${e.name}`,
                      href: `#download-${e.id}`,
                      style: {
                        display: 'flex',
                      ...
                      children: [
                        o.jsx('span', { style: { fontSize: 40 }, children: e.icon }),
                        o.jsx('span', {
              ...
              o.jsx('p', {
                style: { marginTop: 48, fontSize: 14, color: '#9ca3af' },
                children:
      ...
      7718: (e, n, t) => {
        'use strict';
        (t.r(n), t.d(n, { default: () => a, metadata: () => r }));
        var o = t(9013);
        t(6321);
        let r = {
