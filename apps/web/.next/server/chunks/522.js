        ...
        var t = {
            ...
            172: (e, t, r) => {
              ...
              ((t.registerGlobal = function (e, t, r, n = !1) {
                var o;
                let i = (c[s] = null !== (o = c[s]) && void 0 !== o ? o : { version: a.VERSION });
                if (!n && i[e]) {
                  let t = Error(
                ...
                (t.getGlobal = function (e) {
                  var t, r;
                  let n = null === (t = c[s]) || void 0 === t ? void 0 : t.version;
      ...
      let r = 'nxtP',
        ...
        W = {
          ...
          GROUP: {
            ...
            clientOnly: [K.serverSideRendering, K.appPagesBrowser, K.shared],
    ...
    5262: (e, t, r) => {
      ...
      function g(e, t) {
        ...
        e.fetchMetrics.some((e) => r.every((r) => e[r] === t[r])) ||
          e.fetchMetrics.push({ ...t, end: Date.now(), idx: e.nextFetchId || 0 });
      }
      function f(e) {
        var t;
        ...
        globalThis.fetch = (function (
          ...
          let c = async (c, d) => {
            ...
            let v;
            try {
              (((v = new URL(c instanceof Request ? c.url : c)).username = ''), (v.password = ''));
            } catch {
              v = void 0;
            }
            let b = (null == v ? void 0 : v.href) ?? '',
              S = Date.now(),
              h = (null == d ? void 0 : null == (f = d.method) ? void 0 : f.toUpperCase()) || 'GET',
              m = (null == d ? void 0 : null == (_ = d.next) ? void 0 : _.internal) === !0,
            ...
            return (0, a.getTracer)().trace(
              ...
              async () => {
                ...
                let h = c && 'object' == typeof c && 'string' == typeof c.method,
                ...
                ('string' == typeof x &&
                  ...
                  (_ = u(P, v.urlPathname)));
                let A = E('headers'),
                  I = 'function' == typeof (null == A ? void 0 : A.get) ? A : new Headers(A || {}),
                ...
                switch (T) {
                  case 'force-no-store':
                    ...
                    break;
                  case 'only-no-store':
                    if ('force-cache' === x || (void 0 !== _ && (!1 === _ || _ > 0)))
                      throw Error(
                  ...
                  case 'only-cache':
                    ...
                    break;
                  case 'force-cache':
                    (void 0 === P || 0 === P) && ((C = 'fetchCache = force-cache'), (_ = !1));
                }
                (void 0 === _
                  ? 'default-cache' === T
                  ...
                  (v.forceStatic && 0 === _) ||
                    ...
                    (void 0 !== v.revalidate &&
                      ('number' != typeof _ ||
                        (!1 !== v.revalidate &&
                          ('number' != typeof v.revalidate || !(_ < v.revalidate))))) ||
                    (0 === _ && (0, s.trackDynamicFetch)(v, 'revalidate: 0'), (v.revalidate = _)));
                ...
                let V = 'number' != typeof _ ? o.CACHE_ONE_YEAR : _,
                  B = async (t, r) => {
                    ...
                    let o = {
                      ...d,
                      next: { ...(null == d ? void 0 : d.next), fetchType: 'origin', fetchIdx: j },
                    };
                      ...
                      if (
                        ...
                        try {
                          await v.incrementalCache.set(
                            ...
                            { fetchCache: !0, revalidate: _, fetchUrl: b, fetchIdx: j, tags: R },
                          );
                        } catch (e) {
                ...
                if (a && v.incrementalCache) {
                  ...
                  if (
                    (e ? await G() : (f = 'cache-control: no-cache (hard refresh)'),
                      ...
                      e.isStale &&
                        ...
                        v.pendingRevalidates[a] ||
                          (v.pendingRevalidates[a] = B(!0)
                            .catch(console.error)
                            .finally(() => {
                              ((v.pendingRevalidates ??= {}), delete v.pendingRevalidates[a || '']);
                            })));
                      let t = e.value.data;
                      g(v, {
                        start: S,
                ...
                if (v.isStaticGeneration && d && 'object' == typeof d) {
                  ...
                  if (!v.forceStatic && 'no-store' === e) {
                    ...
                    let r = new t(e);
                    ((v.dynamicUsageErr = r), (v.dynamicUsageDescription = e));
                  }
                  let r = 'next' in d,
                    { next: n = {} } = d;
                  if (
      ...
      class b {
        ...
        trace(...e) {
          ...
          let b = this.getSpanContext(
            ...
            S = !1;
          b
            ? (null == (t = s.getSpanContext(b)) ? void 0 : t.isRemote) && (S = !0)
