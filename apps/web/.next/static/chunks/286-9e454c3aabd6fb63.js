  ...
  [286],
  {
    ...
    9562: function (e, t, n) {
      ...
      function D(e) {
        ...
        let { canonicalUrl: F } = (0, s.useUnwrapState)(I),
          ...
          $ = (0, u.useCallback)(
            (e) => {
              ...
              (0, u.startTransition)(() => {
                k({ type: a.ACTION_SERVER_PATCH, previousTree: t, serverResponse: n });
              });
            },
            [k],
          ),
        ...
        (0, u.useEffect)(() => {
          let e = window.history.pushState.bind(window.history),
            ...
            n = (e) => {
              ...
              (0, u.startTransition)(() => {
                k({ type: a.ACTION_RESTORE, url: new URL(null != e ? e : n, n), tree: r });
              });
            };
        ...
        return (0, o.jsxs)(o.Fragment, {
          children: [
            (0, o.jsx)(x, { appRouterState: (0, s.useUnwrapState)(I), sync: U }),
    ...
    8703: function (e, t, n) {
      ...
      function O(e) {
        ...
        let { childNodes: O, tree: E, url: S, loading: w } = m,
          T = O.get(t);
          ...
          o.inFlightServerAction.then(
            async (r) => {
              ...
              for (let n of ((o.inFlightServerAction = null), b)) {
                ...
                let [r] = n,
                  l = (0, i.applyRouterStatePatchToTree)([''], _, r, u);
                if (null === l) return (0, h.handleSegmentMismatch)(e, t, r);
                if ((0, c.isNavigatingToNewRootLayout)(_, l))
